...
curl -L -o schwung-norns/dist/norns-module.tar.gz https://github.com/djhardrich/schwung-norns/releases/download/v0.4.1/norns-module.tar.gz
curl -L -o schwung-norns/dist/norns-move-prebuilt.tar.gz https://github.com/djhardrich/schwung-norns/releases/download/v0.4.1/norns-move-prebuilt.tar.gz
