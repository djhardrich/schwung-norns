...
git clone https://github.com/djhardrich/schwung-pipewire

mkdir -p schwung-norns/dist schwung-pipewire/dist
...
curl -L -o schwung-pipewire/dist/pipewire-module.tar.gz https://github.com/djhardrich/schwung-pipewire/releases/download/v0.2.0/pipewire-module.tar.gz
curl -L -o schwung-pipewire/dist/pw-chroot-desktop.tar.gz https://github.com/djhardrich/schwung-pipewire/releases/download/v0.2.0/pw-chroot-desktop.tar.gz

cd schwung-pipewire && ./scripts/install.sh
